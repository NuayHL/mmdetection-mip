...
# ============================================================
# AITOD-v2  Detectors  —  DSL-DYAB-RCNN size-dependent
#
# Applies the DSL-DYAB-RCNN (size-dependent expansion + DyabDSL)
# improvement to the DetectoRS_ResNet + RFP backbone.
#
# Uses DynAssignRoIHead (same head as the Faster R-CNN DSL version)
# to isolate backbone/neck differences from the RoI head.
#
# Run from repo root:
#   bash configs_m/aitodv2_detectors_dsl_aref/run_all.sh
# ============================================================
set -euo pipefail

EXP_PREFIX="aitodv2_detectors_dsl_aref"
...
#
run_one "dsl_dyab_rcnn_adapt"  "configs_m/aitodv2_detectors_dsl_aref/dsl_dyab_rcnn_adapt.py"
...
echo "  detectors baseline  → work_dirs/aitodv2_detectors/aitodv2_iou_detectors_cascade-rcnn_r50_2x/"
echo "  faster_rcnn DSL     → work_dirs/aitodv2_faster_rcnn_dsl_aref/dsl_dyab_rcnn_adapt/"
