...
custom_imports = dict(imports=['mmdet.models', 'mmdet.engine'], allow_failed_imports=False)
...
model = dict(
    ...
    neck=dict(
        ...
        act_cfg=dict(type='Swish')),
    bbox_head=dict(
        type='YOLOX_test2_l_refine_Head',
        num_classes=20,
        in_channels=128,
        feat_channels=128,
        stacked_convs=2,
...
custom_hooks = [
    ...
    dict(
        ...
        update_buffers=True,
        priority=49),
    dict(type='ChangeTempHook', fin_temp=10.0, priority=0)
]
