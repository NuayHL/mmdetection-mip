...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root ,
        ann_file='annotations_v1/aitod_train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations_v1/aitod_val.json',
...
val_evaluator = dict(
    ...
    ann_file=data_root + 'annotations_v1/aitod_val.json',
    metric='bbox',
    format_only=False,
    backend_args=backend_args)
