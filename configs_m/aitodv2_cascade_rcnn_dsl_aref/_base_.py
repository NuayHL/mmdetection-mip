"""Shared base for the AITOD-v2 Cascade R-CNN DSL-AreaRefine experiments.

Built on the Cascade R-CNN model skeleton, keeping the 3-stage cascade
...
# Keep CascadeRCNN type — DynAssignCascadeRoIHead is a CascadeRoIHead subclass.
# Override general backbone/neck/RPN settings shared across experiments.
model = dict(
    roi_head=dict(
        bbox_head=[
